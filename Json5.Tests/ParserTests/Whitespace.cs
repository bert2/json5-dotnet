...
public class Whitespace {
    ...
    [Fact] void BomIsSkippedAsWell() => Parser.Parse("\uFEFF'nope not yet'").Should().Be("nope not yet");
    ...
    [Fact] void NextLineCharIsSkippedToo() => Parser.Parse("\u0085'now we done'").Should().Be("now we done");
}

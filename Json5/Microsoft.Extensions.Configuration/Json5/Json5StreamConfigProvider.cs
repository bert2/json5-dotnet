...
/// <summary>Provides configuration key-value pairs that are obtained from a JSON5 stream.</summary>
/// <remarks>Initializes a new instance of the <see cref="Json5StreamConfigProvider"/> class.</remarks>
...
public class Json5StreamConfigProvider(Json5StreamConfigSource source) : StreamConfigurationProvider(source) {
    /// <summary>Loads JSON5 configuration key-value pairs from a stream into a provider.</summary>

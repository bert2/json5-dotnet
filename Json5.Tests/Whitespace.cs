...
public class Whitespace {
    ...
    [Fact] void BomIsSkippedAsWell() => Json5.Parse("\uFEFF'nope not yet'").Should().BeValue("nope not yet");
    ...
    [Fact] void NextLineCharIsSkippedToo() => Json5.Parse("\u0085'now we done'").Should().BeValue("now we done");
}

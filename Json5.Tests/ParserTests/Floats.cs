...
public class Floats {
    public class Infinity {
        ...
        [Fact(Skip = "no ∞")] void Symbol() => Parser.Parse("-∞").Should().Be(double.NegativeInfinity);
    ...
    public class NaN {
        [Fact] void MixedCase() => Parser.Parse("NaN").Should().Be(double.NaN);
        [Fact] void UpperCase() => Parser.Parse("NAN").Should().Be(double.NaN);
        [Fact] void LowerCase() => Parser.Parse("nan").Should().Be(double.NaN);
        [Fact] void Positive() => Parser.Parse("+NaN").Should().Be(double.NaN);
        [Fact] void Negative() => Parser.Parse("-NaN").Should().Be(double.NaN);
    }
    ...
    private static double RoundTrip(double x)
        => Parser.Parse(x.ToString(CultureInfo.InvariantCulture))!.Deserialize<double>(jsonOpts);
